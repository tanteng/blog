...
![Agent 与 Harness 的关系：Agent 是用户感知的行为，Harness 是背后的基础设施](https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/05/6c5adaa1f978903205f2135d4328e098.png)
...
![Agent Harness 的 12 个核心组件](https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/05/e52c88833a985c7dae747322ec2bb896.png)
...
这是许多智能体容易暗中翻车的地方。核心问题在于上下文腐烂：当关键信息处于窗口中间位置时，模型表现会下降 30% 以上（这就是斯坦福大学发现的”迷失在中间”现象）。即便是支持百万级 Token 的窗口，随着上下文的增长，指令遵循能力也会退化。
...
对于结构化输出，OpenAI 和 LangChain 都支持通过 Pydantic 模型进行模式约束。
...
![12 个组件的协同工作流程图](https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/05/526dc1092050e8614c0f3e39dd1a25e9.png)
...
![Agent Harness 的工作循环：提示词组装 → 模型推理 → 输出分类 → 工具执行 → 结果打包 → 上下文更新](https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/05/968af88d7de4651c4a3813a0e3d52644.png)
...
![建筑脚手架：临时性基础设施，让工人能触及原本够不到的高度](https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/05/164fcffb1a70aa394d89635ea76bfa9a.png)
...
![Harness 与模型的协同进化曲线](https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/05/faee74478233fdb5e3d338e6cc24dda9.png)

## 架构师的七个关键抉择

![架构师面临的七个关键抉择](https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/05/ff633309fbde96fc1f129aec02df8ae5.png)

每个 Harness 的架构师都面临这七个选择：

1. **单智能体 vs. 多智能体**：官方建议先充分挖掘单智能体的潜力。多智能体会带来额外的开销和信息损耗。
...
> 转载出处：https://x.com/dotey/status/2053601852261110201
>
> 原作者：@akshay_pachaar