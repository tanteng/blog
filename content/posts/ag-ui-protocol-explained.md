...
categories: ["tech"]
featured_image: 'https://notes-1303209934.cos.ap-guangzhou.myqcloud.com/2026/03/2d34e27c6e4d4db16718d39c6bc6cd5d.png'
---
...
| 协议 | 作用 | 比喻 |
|-----|------|------|
| **MCP** | Agent 用什么工具 | 手（操作外部世界） |
| **A2A** | Agent 之间怎么沟通 | 语言（与其他 Agent 对话） |
| **AG-UI** | Agent 怎么跟用户对话 | 脸（展示给用户看） |
